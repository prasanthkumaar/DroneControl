...
public class ConnectionActivity extends Activity implements View.OnClickListener {
    ...
    private void refreshSDKRelativeUI() {
        ...
        if (null != mProduct && mProduct.isConnected()) {
            ...
            String productName = mProduct.getModel().getDisplayName();
            String connectedString = getResources().getString(R.string.connected, productName);
            mTitle.setText(connectedString);
